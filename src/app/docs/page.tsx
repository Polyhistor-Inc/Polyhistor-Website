      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 backdrop-blur-xl bg-[#0f1117]/90">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/waitlist" className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition">Join Waitlist</Link>
          </div>
        </div>
      </nav>
            ...
            <div className="space-y-6 mt-8">
              {[
                ...
                <div key={step.num} className="flex gap-4">
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#667eea] to-[#764ba2] text-white text-[13px] font-bold flex items-center justify-center flex-shrink-0">
                    {step.num}
                  </div>
                  <div>
...
data = res.json()`}
  ...
  "waitlist_id": "wl_abc123"
          ...
          <div className="mt-16 pt-8 border-t border-white/5 text-center">
            ...
            <Link href="/waitlist" className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-6 py-2.5 rounded-lg font-medium hover:opacity-90 transition inline-block">Join the Waitlist</Link>
          </div>
        </main>
      </div>
    </main>
