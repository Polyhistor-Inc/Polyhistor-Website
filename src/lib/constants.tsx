...
export const FEATURES = [
  ...
  {
    icon: (
      <svg aria-hidden="true" className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    icon: (
      <svg aria-hidden="true" className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    icon: (
      <svg aria-hidden="true" className="w-6 h-6 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const USE_CASES = [
  {
    icon: (
      <svg aria-hidden="true" className="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
